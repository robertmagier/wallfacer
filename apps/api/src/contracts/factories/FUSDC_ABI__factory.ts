...
import type { FUSDC_ABI, FUSDC_ABIInterface } from "../FUSDC_ABI";
...
export class FUSDC_ABI__factory {
  static readonly abi = _abi;
  static createInterface(): FUSDC_ABIInterface {
    return new Interface(_abi) as FUSDC_ABIInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): FUSDC_ABI {
    return new Contract(address, _abi, runner) as unknown as FUSDC_ABI;
  }
}
